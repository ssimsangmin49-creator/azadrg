...
This project does not attempt to redefine established combustion taxonomy.
Instead, it uses “flame regime” to describe an operational observation: the system behaves more like a gas-phase reacting environment than a conventional mass-burn incineration process.
...
<p style="text-align:center; margin:2.5rem auto;">
  <img src="/images/flame4.png" alt="Field observation of flame evolution" style="max-width:700px; width:100%;">
  <br>
  <span style="display:inline-block; margin-top:0.75rem; font-size:0.9rem; color:#9ca3af;">
...
Reaction behavior → influences → flame regime formation
Flame regime → influences → emission characteristics and thermal stability

The emphasis is therefore placed on understanding thermal response patterns rather than waste identity alone.
